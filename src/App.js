  ...
  return (
    <div className="bg-blue-100 font-sans">
      <div className={classes.root} style={{marginBottom: "20px"}}>
        <AppBar position="static"  style={{ backgroundColor: "hsla(260, 60%, 60%, 1)" }}>
        <Toolbar className="flex justify-between">
            <img src="https://cdn.worldvectorlogo.com/logos/scratch-logo.svg" style={{ height: '50px', width: '100px', display: 'flex'}} />
            <Button color="inherit">
              <GitHubIcon
                onClick={() =>
                  (window.location.href =
                    "https://github.com/krgauravsk/Gaurav-Assignment")
                }
              />
            </Button>
          </Toolbar>
